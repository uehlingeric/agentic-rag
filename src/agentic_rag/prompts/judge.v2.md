...
5: Directly and completely answers every part of the specific question, at the right level of detail.
4: Answers the question with minor gaps or minor off-topic content.
3: Answers only part of a multi-part question, or addresses the topic but misses a key part of what was asked — even when the omission is acknowledged honestly.
2: Mostly misses the point; answers a related but different question.
1: Does not address the question.
If the question has multiple parts, score relevance against ALL parts: an answer that fully addresses only one of two parts scores at most 3, even if it explains why the other part cannot be answered.
